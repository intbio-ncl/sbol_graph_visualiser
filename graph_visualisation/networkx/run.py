...
class NetworkxRunner(Cmd):
    def __init__(self,visualiser):
        super(NetworkxRunner, self).__init__()
        self.visualiser = visualiser
        self.visualiser_options = self._generate_options()

    prompt = 'nxr> '
    intro = "NetworkxVisualiser Type ? to list commands\n Type build to build graph."
    ...
    def _generate_options(self):
        blacklist_functions = [self.visualiser.save_visualisation,
                               self.visualiser.show_graph,
                               self.visualiser.build,
                               self.visualiser.build_settings
                               ]
        options = {"presets" : {"full_graph_preset" : self.visualiser.set_full_graph_preset,
                    ...
                    "layouts" : {"no_layout" : self.visualiser.set_no_layout,
                                 "spring_layout" : self.visualiser.set_spring_layout,
                                 ...
                                 "tree_layout" : self.visualiser.set_tree_layout,
                                 "ego_layout" : self.visualiser.set_ego_layout},
                    "misc" : {}}
...
def nwx_runner(nwx_visualiser,title = None):
    runner = NetworkxRunner(nwx_visualiser)
    runner.cmdloop()
